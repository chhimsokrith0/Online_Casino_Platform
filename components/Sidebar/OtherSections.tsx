      ...
      {session && (
        <div>
          ...
          <div
            ...
            className={`bg-gray-700 flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer transition-all hover:bg-gray-700 active:bg-gray-600 ${activeItem === "inviteAndBenefit" ? "bg-gray-700 text-white" : "text-gray-400"
              }`}
          >
            {/* Icon */}
            <img
              src="https://res.cloudinary.com/dfxqagrkk/image/upload/v1735966455/special_bonus_menu_hejz13.svg"
              alt="Special Bonus Icon"
              className="w-8 h-8"
            />
