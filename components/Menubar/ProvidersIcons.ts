...
// Import placeholder for missing icons
import placeholderIcon from "@/assets/icon_Providers/download.png"; // Fallback icon
...
const ProvidersIcons = [
  ...
  { name: "Amigo", icon: placeholderIcon }, // Placeholder for missing Amigo.svg
